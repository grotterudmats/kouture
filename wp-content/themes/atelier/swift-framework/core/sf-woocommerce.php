<?php
    ...
    */
	...
	================================================== */
	if ( ! function_exists( 'sf_woo_disable_slider' ) ) {
		function sf_woo_disable_slider() {
			global $sf_options;
		...
		add_action( 'wp', 'sf_woo_disable_slider' );
	}
                            ...
                            <?php if ( $cart_count != "0" ) { ?>
                                ...
                                <div class="bag-contents">
                                    ...
                                    <?php foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) { ?>
                                        ...
                                        ?>
                                            	...
                                            	<div class="bag-product clearfix  product-id-<?php echo $cart_item['product_id']; ?> <?php echo esc_attr( $variation_id_class ); ?>">
                                ...
                                <?php if ( sf_theme_opts_name() == "sf_atelier_options" || sf_theme_opts_name() == "sf_uplift_options" ) { ?>
				                    ...
				                    <div class="bag-total">
					                    ...
					                    <?php } ?>
					                    <?php if ( WC()->cart->prices_include_tax ) { ?>
    ...
    if ( !function_exists('sf_product_shop_count') ) {
		function sf_product_shop_count($original_count) {
    ...
    /* CROSS SELLS COLUMNS
    ================================================== */
    function sf_woocommerce_cross_sells_cols() {
    	return 4;
    }
    add_filter( 'woocommerce_cross_sells_columns', 'sf_woocommerce_cross_sells_cols' );

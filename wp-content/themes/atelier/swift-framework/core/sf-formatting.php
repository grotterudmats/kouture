<?php
    ...
    */
    ...
    ================================================== */
    if ( ! function_exists( 'sf_get_the_content_with_formatting' ) ) {
    ...
    if ( ! function_exists( 'sf_add_formatting' ) ) {
    ...
    if ( ! function_exists( 'sf_custom_excerpt' ) ) {
    ...
    ================================================== */
    if ( ! function_exists( 'sf_tag_cloud_args' ) ) {    
    ...
    ================================================== */
    if ( ! function_exists( 'sf_category_widget_mod' ) ) { 
    ...
    ================================================== */
    if ( ! function_exists( 'sf_archives_widget_mod' ) ) { 
    ...
    ================================================== */
    if ( ! function_exists( 'sf_add_cpt_tags_to_archive' ) ) {
    ...
    if ( ! function_exists( 'sf_pt_search_filter' ) ) {
     ...
     */
    if ( ! function_exists( 'sf_format_chat_content' ) ) {
     ...
     */
    if ( ! function_exists( 'sf_format_chat_row_id' ) ) {

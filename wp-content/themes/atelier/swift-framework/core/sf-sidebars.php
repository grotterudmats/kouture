    ...
    if ( ! function_exists( 'sf_register_sidebars' ) ) {
        function sf_register_sidebars() {
            if ( function_exists( 'register_sidebar' ) ) {
                ...
                $sidebar_before_title = apply_filters( 'sf_sidebar_before_title', '<div class="widget-heading title-wrap clearfix"><h4 class="spb-heading widget-title"><span>' );
                $sidebar_after_title = apply_filters( 'sf_sidebar_after_title', '</span></h4></div>' );
				$footer_before_title = apply_filters( 'sf_footer_before_title', '<div class="widget-heading title-wrap clearfix"><h6 class="widget-title">' );
				$footer_after_title = apply_filters( 'sf_footer_after_title', '</h6></div>' );
				$gb_before_title 	= apply_filters( 'sf_gb_before_title', '<div class="widget-heading title-wrap clearfix"><h6 class="widget-title">' );

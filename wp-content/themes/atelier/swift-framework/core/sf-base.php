    ...
    if ( ! function_exists( 'sf_base_sidebar' ) ) {
        function sf_base_sidebar($type) {
            ...
            if ( is_page_template( 'template-edd-store-front.php' ) ) { 
                $sidebar_config = $sf_options['edd_archive_sidebar_config'];
                $dleft_sidebar   = $sf_options['edd_archive_sidebar_left'];
                $right_sidebar  = $sf_options['edd_archive_sidebar_right'];
            }
            ...
            if ( is_tax( 'download_category' ) && class_exists( 'ATCF_Campaigns' ) ) {
                ...
                $default_sidebar_config = $sf_options['edd_archive_sidebar_config'];
                $default_left_sidebar   = $sf_options['edd_archive_sidebar_left'];
                $default_right_sidebar  = $sf_options['edd_archive_sidebar_right'];
            } else if ( is_tax( 'download_tag' ) && sf_edd_activated() ) {
                $default_sidebar_config = $sf_options['edd_archive_sidebar_config'];
                $default_left_sidebar   = $sf_options['edd_archive_sidebar_left'];
                $default_right_sidebar  = $sf_options['edd_archive_sidebar_right'];
            }

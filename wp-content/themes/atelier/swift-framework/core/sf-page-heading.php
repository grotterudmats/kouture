    ...
    */
    ...
    if ( ! function_exists( 'sf_page_heading' ) ) {
        function sf_page_heading() {
            ...
            $show_page_title    = apply_filters( 'sf_page_heading_ns_pagetitle', $default_show_page_heading );
				...
				if ( function_exists('is_checkout') && is_checkout() ) {
		        	...
		        	if ( $sf_options['minimal_checkout'] ) { ?>
		            	...
		            	<div class="minimal-checkout-return container">
		            		<?php echo sf_logo( 'logo-left checkout-logo', 'logo' ); ?>
		            		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php _e("Return to cart", "swiftframework"); ?></a>
		            	</div>

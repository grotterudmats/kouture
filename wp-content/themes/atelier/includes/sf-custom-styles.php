...
//            echo '.woocommerce input.button:hover, .woocommerce a.button:hover {background-color:'.$secondary_accent_color.';color:'.$accent_alt_color.';}';			
			...
			echo '.woocommerce .woocommerce-widget-layered-nav-dropdown .select2-container--default .select2-selection--single {border-color: ' . $section_divide_color . ';background-color: ' . $input_bg_color . ';color:' . $input_text_color . ';}';
            echo '.woocommerce .woocommerce-widget-layered-nav-dropdown .select2-container--default .select2-selection__placeholder {color:' . $input_text_color . ';}';

			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle' => __('Upload a dark version of your logo here, which will be used wherever you use the Naked (Dark) Header option. If no dark logo is set, then the standard will be used.', 'swiftframework'),
						'desc' => ''
						),
					array(
						'id' => 'alt_logo_upload',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'typekit_id',
						'type' => 'text',
						'title' => __('Typekit ID', 'swiftframework'),
					...
					array(
						'id' => 'typekit_id_fonts',
						'type' => 'raw',
						'title' => __('Your Available Kits', 'swiftframework'),
						'content'  => sf_get_typekit_kit(),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'edd_display_type',
						'type' => 'select',
						'title' => __('EDD Display Type', 'swiftframework'),
					...
					array(
						...
						'type' => 'select',
						'title' => __('Shop/Archive Sidebar Config', 'swiftframework'),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
					    ...
					    'desc'      => __('The amount of products you would like to show per page on shop/category pages. If blank, the default WooCommerce options will be used (in the customizer).', 'swiftframework'),
					    'validate'  => 'numeric',
					    'default'   => '',
					),
					array(
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle' => __('Disable the slider if you would like the images to show one after another on the product detail page. NOTE: As of WooCommerce 2.7, this option is no longer used.', 'swiftframework'),
						'desc' => '',
					...
					array(
						...
						'type' => 'button_set',
						'title' => __('Original product slider', 'swiftframework'),
						'subtitle' => __('Enable this option if you would like to use the original product slider, with the navigation arrows and iLightbox setup. Please note, we cannot guarantee 3rd party plugin support relating to the product page with this enabled.', 'swiftframework'),
						'desc' => '',
						'options' => array('0' => 'Disabled','1' => 'Enabled'),
						'default' => '0'
						),
					...
					array(
						...
						'subtitle' => __('Choose whether you would like to enable product image zoom functionality on the product detail page images. NOTE: This only works when you have the product slider enabled, and is only taken into effect when you are using WC 2.6 or lower.', 'swiftframework'),
						'desc' => '',
						'options' => array('1' => 'On','0' => 'Off'),
						'default' => '0'
						),
					array(
						...
						'subtitle' => __('Choose whether you would like to enable product image zoom functionality on the product detail page images. NOTE: this is only taken into effect when you are using WC 2.6 or lower.', 'swiftframework'),
						'desc' => '',
					...
					array(
						...
						'type' => 'select',
						'title' => __('Default Product Page Display Type', 'swiftframework'),

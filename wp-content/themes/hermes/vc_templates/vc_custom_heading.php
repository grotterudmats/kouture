...
$sub_heading_tag = (!empty($sub_heading_tag)) ? $sub_heading_tag : 'h4';
$output = '';
if ( apply_filters( 'vc_custom_heading_template_use_wrapper', false ) ) {
	...
	$output .= (!empty($sub_heading)) ? '<'. $sub_heading_tag .' class="sub-heading-text">'. esc_html($sub_heading) .'</'. $sub_heading_tag .'>' : '';
	$output .= '</div>';
} else {

...
global $post, $wpdb, $hermes_opt;

?>
<div class="main-container">
	<div class="entry-header">
		<div class="container">
			<h1 class="entry-title"><?php esc_html_e('Portfolio', 'hermes');?></h1>
		</div>
	</div>
	<div class="container">
		<?php
				...
				<div class="col-xs-12 col-md-<?php if ( $attachment_ids || has_post_thumbnail()) { echo '6';} else {echo '12';} ?>">
					...
					<div class="project-meta">
						<div class="project_date ">
							<p><strong><?php echo esc_html__('Date', 'hermes') ?></strong></p>
							<span class="day"><?php echo get_the_date(esc_html__('d', 'hermes')); ?></span>
							<span class="separator">/</span>
							<span class="month"><?php echo get_the_date(esc_html__('M', 'hermes')); ?></span>
						</div>
					
					
						<?php if (!empty($datagroup)) { ?>
						<div class="categories-entry">
							<p class="cat-label"><strong><?php echo esc_html__('Categories', 'hermes') ?></strong></p> <?php echo implode(", ", $datagroup); ?> 
						</div>
						...
						<div class="client-entry">
							<p class="client-label"><strong><?php echo esc_html__('Client', 'hermes') ?></strong></p> <?php echo esc_html($client); ?>
						</div>
						<?php } ?>
						<?php $url = esc_attr( get_post_meta( get_the_ID(), '_url', true ) ); ?>
						<?php if($url){ ?>
						<div class="url-entry">
							<p class="link-label"><strong><?php echo esc_html__('Link', 'hermes') ?></strong></p> <a href="<?php echo esc_url($url) ?>"><?php echo esc_html__('Visit project', 'hermes') ?></a>
						</div>
						<?php } ?>
						<?php $testimonial = esc_attr( get_post_meta( get_the_ID(), '_testimonials_search', true ) ); ?>
						<?php if($testimonial){ ?>
						<div class="testimonial-entry">
							<p class="testimonial-label"><strong><?php echo esc_html__('Testimonial', 'hermes') ?></strong></p> <?php echo esc_html($testimonial); ?>
						</div>
						<?php } ?>
						<div class="social-sharing clearfix">
							<?php $liked = hermes_check_liked_post(get_the_ID()); ?>
							<?php hermes_blog_sharing(); ?>
							<div class="likes-counter">
								<a title="<?php echo (!$liked) ?  esc_html__('Like this portfolio', 'hermes') : esc_html__('Unlike this portfolio', 'hermes'); ?>" data-toggle="tooltip" class="hermes_like_post<?php echo ($liked) ? ' liked':''; ?>" href="javascript:void(0)" data-post_id="<?php the_ID() ?>" data-liked_title="<?php echo esc_html__('Unlike this portfolio', 'hermes') ?>" data-unliked_title="<?php echo esc_html__('Like this portfolio', 'hermes') ?>">
	...
	<?php
		...
		<div class="related_projects">
			<h3 class="related-title"><?php echo esc_html($hermes_opt['related_project_title']); ?></h3>
					...
					<div class="item-related">
							...
							<div class="project-thumbnail">
								...
								<div class="icon-group">
									<div class="project-link"><a data-toggle="tooltip" title="<?php echo esc_html__('View more', 'hermes') ?>" href="<?php the_permalink(); ?>" class="project-permalink"><i class="fa fa-link"></i></a></div>
									<div class="likes-counter">
										<a title="<?php echo (!$liked) ?  esc_html__('Like this portfolio', 'hermes') : esc_html__('Unlike this portfolio', 'hermes'); ?>" data-toggle="tooltip" class="hermes_like_post<?php echo ($liked) ? ' liked':''; ?>" href="javascript:void(0)" data-post_id="<?php the_ID() ?>" data-liked_title="<?php echo esc_html__('Unlike this portfolio', 'hermes') ?>" data-unliked_title="<?php echo esc_html__('Like this portfolio', 'hermes') ?>">
											<i class="fa fa-heart"></i><span class="number"><?php echo hermes_get_liked(get_the_ID()); ?></span>
										</a>
